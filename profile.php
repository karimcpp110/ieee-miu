...
// Fetch stats to get "Mastery Level"
$stats = $db->query("SELECT courses_completed, events_attended FROM user_stats WHERE user_id = ?", [$studentId])->fetch();
$coursesCompleted = $stats ? (int)$stats['courses_completed'] : 0;
$eventsAttended = $stats ? (int)$stats['events_attended'] : 0;

$masteryLevel = "Novice";
if ($coursesCompleted >= 1) $masteryLevel = "Learner";
if ($coursesCompleted >= 3) $masteryLevel = "Scholar";
if ($coursesCompleted >= 5) $masteryLevel = "Expert";
if ($coursesCompleted >= 10) $masteryLevel = "Master";
