        ...
        <div class="nav-links" id="nav-links">
            ...
            <?php if (Auth::check()): ?>
                ...
                <div class="notification-wrapper">
                    <button id="noti-bell" class="noti-btn" title="Notifications">
            ...
            <?php elseif (isset($_SESSION['student_logged_in'])): ?>
                <div class="user-pill glass-panel">
                    ...
                    <!-- Bell for students -->
                    <div class="notification-wrapper" style="margin: 0 0.5rem;">
                        <button id="noti-bell" class="noti-btn" title="Notifications">
                            <i class="fas fa-bell"></i>
                            <span id="noti-count" class="noti-count" style="display:none;">0</span>
                        </button>
                ...
                .then(data => {
                    ...
                    if (count > 0) {
                        ...
                        notiList.innerHTML = data.map(n => `
                            <div class="noti-item ${n.type}" data-id="${n.id}">
                                <div class="noti-icon">${n.type === 'success' ? '🏆' : n.type === 'info' ? '📢' : '⚠️'}</div>
                                <div class="noti-body">
...
<style>
    ...
    .noti-item.success .noti-title { color: #2ecc71; }
    .noti-item.info .noti-title { color: var(--primary-neon); }
    .noti-item.warning .noti-title { color: #ffa502; }
