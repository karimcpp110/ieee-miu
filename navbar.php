...
<nav class="glass-panel main-nav">
    <div class="nav-container">
        <div class="nav-logo">
            IEEE <span class="text-gradient">MIU</span>
        </div>
        ...
        <div class="nav-links" id="nav-links">
            ...
            <a href="courses.php" class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'courses.php' ? 'active' : '' ?>">Courses</a>
            <?php if (Auth::check()): ?>
            ...
            <?php elseif (isset($_SESSION['student_logged_in'])): ?>
                <div class="user-pill glass-panel">
                    <span class="hi-text">Hi, <?= htmlspecialchars(explode(' ', $_SESSION['student_name'])[0]) ?></span>
