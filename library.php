...
<head>
    ...
    <style>
        ...
        .resource-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 1.5rem; margin-top: 1.5rem; }
        ...
        <main class="portal-main-area">
            ...
            <div class="resource-grid">
                <div class="portal-glass-panel">
                    <h3 style="margin-top:0;">VLSI Design Paper</h3>
                    <p style="color:var(--text-muted); font-size:0.85rem;">Intro to Advanced Chip Architecture</p>
                    <button style="background:var(--portal-accent-blue); color:white; border:none; padding:10px 15px; border-radius:10px; cursor:pointer; font-weight:700;">Download <i class="fas fa-download"></i></button>
                </div>
                <div class="portal-glass-panel">
                    <h3 style="margin-top:0;">IEEE 802.11 Protocols</h3>
                    <p style="color:var(--text-muted); font-size:0.85rem;">Wireless Communication Foundations</p>
                    <button style="background:var(--portal-accent); color:white; border:none; padding:10px 15px; border-radius:10px; cursor:pointer; font-weight:700;">Download <i class="fas fa-download"></i></button>
                </div>
            </div>
        </main>
    </div>
