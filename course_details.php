...
<body>
            ...
            <div class="details-body">
                    ...
                    <div class="access-content">
                            ...
                            <div class="content-main-wrapper">
                                <?php if (!empty($course['file_path'])): ?>
                                    <div class="file-download-box glass-panel">
                                        ...
                                        <a href="<?= htmlspecialchars($course['file_path']) ?>" download
                        ...
                        <?php else: ?>
                            <div class="locked-state">
                                ...
                                <p>This module is part of the certified IEEE MIU curriculum. Please enroll below to gain
                                    access to videos, resources, and sessions.</p>
                                    ...
                                    <?php foreach ($records as $r): ?>
                                        <div class="extra-item glass-panel">
                                            ...
                                            <div class="extra-info">
                                                ...
                                                <?php if ($r['content']): ?>
                                                    <p><?= htmlspecialchars($r['content']) ?></p><?php endif; ?>
                                            </div>
                                            <?php if ($r['file_path']): ?>
                                                <a href="<?= htmlspecialchars($r['file_path']) ?>" target="_blank"
                                                    class="btn btn-sm btn-primary"><i class="fas fa-external-link-alt"></i> View</a>
                                            <?php endif; ?>
                                        </div>
                                    <?php endforeach; ?>
                                </div>
                ...
                <?php if (!$canView): ?>
                    <div class="section-header-centered">
                        ...
                        <?php if (!isset($_SESSION['student_logged_in'])): ?>
                            <p class="login-prompt">Already have an account? <a href="student_login.php"
                                    class="text-gradient">Login</a> to keep your progress.</p>
                        <?php endif; ?>
                    </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="contact" class="form-input" required
                                    value="<?= isset($_SESSION['student_email']) ? htmlspecialchars($_SESSION['student_email']) : '' ?>"
                                    placeholder="e.g. +20 100 123 4567">
                            </div>
                        </div>
                        <button type="submit" class="btn btn-primary btn-full">Submit Enrollment <i
    ...
    <style>
        ...
        .content-access-section {
            ...
            box-shadow: 0 0 30px rgba(0, 98, 155, 0.1);
        }
